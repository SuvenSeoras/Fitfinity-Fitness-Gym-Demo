...
const SmoothScroll = () => {
  useEffect(() => {
    // Initialize Lenis with default settings which are usually more robust for trackpads
...
const App: React.FC = () => {
  return (
    <Router>
      <SmoothScroll />
      <ScrollToTop />
      {/* Added overflow-x-hidden here to prevent horizontal scroll on trackpads without locking vertical scroll on body */}
      <div className="min-h-screen flex flex-col font-sans text-white antialiased selection:bg-neon-blue selection:text-black relative overflow-x-hidden">
        <LiquidBackground />
